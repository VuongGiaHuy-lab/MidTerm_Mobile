...
import com.example.quanlychitieu.database.ExCategoryTable;
import com.example.quanlychitieu.database.InCategoryTable;
...
import com.example.quanlychitieu.model.InCategory;
import com.example.quanlychitieu.tools.BigDecimalCalculator;
import com.example.quanlychitieu.tools.CurrencyFormatter;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        } else if (id == R.id.nav_income_category) {
    ...
    View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            } else if (id == R.id.netEarnings_monthly_cardView) {
            ...
            } else if (id == R.id.earning_progress_view) {
                Intent incomeIntent = new Intent(MainActivity.this, ShowingIncomeActivity.class);
                startActivity(incomeIntent);
            }
        }
